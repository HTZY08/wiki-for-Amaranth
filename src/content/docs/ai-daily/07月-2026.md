---
title: 2026年7月 AI云组会
description: 2026年7月 — 8期日报，Loop Engineering 定形、JadePuffer 全球首例AI勒索、Claude Sonnet 5 发布、MCP stateless化、Agent 安全事件频发
---
...
1. **Loop Engineering 从热词变成方法**——Andrew Ng 在 7/2 和 7/4 两次发推，给出三层定义。Boris Cherny 和 Karpathy 在 7/8 分别将其推到 Agentic Engineering 的高度。

2. **Agent 安全从理论变成案件**——JadePuffer（7/6）是首例有记录的 AI Agent 全链勒索攻击，Cursor DuneSlide（7/6）暴露了 coding agent 本身作为攻击入口的风险。Agentic security 不再只是论文里的概念。

3. **中美 AI 对抗延伸到工具层**——阿里 7/10 封杀 Claude Code（7/6），背景是 6 月底的蒸馏指控。继模型出口管制后的第二战场。

4. **Claude Sonnet 5 以价格重新定义竞争维度**——促销价 $2/$10（7/7 发布），agent 工作流的经济性第一次成为头版新闻。

5. **MCP 走向 stateless**（7/8 RC）——无握手无 session，agent 工具层可水平扩展。基础设施层的架构升级。

6. **DeepSeek 归来**——梁文锋首篇论文 DSpark（7/7），85% 加速零质量损失，证明团队在危机后仍能产出前沿成果。

7. **机器人 + Agent 融合进入实验验证阶段**——NVIDIA ASPIRE 和 GEAR 舰队，agent 在物理世界中的涌现行为已被多次观察和记录。
