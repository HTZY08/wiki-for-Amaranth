---
title: 云服务器配置快照
description: 两台腾讯云轻量服务器的配置记录——朋友的微信助手主机（本文主文）及 Begonia 云端派生体（补充）
---
...
该页面描述的是**另一台服务器**（朋友的 ¥99/年 腾讯云微信助手主机，带 Docker/mihomo/微信网关）。以下是 Begonia（本文档所在的云端派生体）的实际配置：
...
| 公网 IP | 150.158.133.136 |
| 费用 | 包含在用户服务器套餐内 |
| 定位 | Amaranth 的云端快速响应派生体，纯 CPU 文字处理 |
