...
> 原文地址: [`user-guide/messaging/msgraph-webhook.md`](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/messaging/msgraph-webhook.md)
> 本版本为自用学习用途，非官方翻译。
