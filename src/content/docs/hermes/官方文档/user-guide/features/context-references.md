...
> 原文地址: [`user-guide/features/context-references.md`](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/context-references.md)
> 本版本为自用学习用途，非官方翻译。
