...
> 原文地址: [`user-guide/features/codex-app-server-runtime.md`](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/codex-app-server-runtime.md)
> 本版本为自用学习用途，非官方翻译。
