...
> 原文地址: [`user-guide/features/memory-providers.md`](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md)
> 本版本为自用学习用途，非官方翻译。
