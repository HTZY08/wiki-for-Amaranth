...
> 原文地址: [`guides/operate-teams-meeting-pipeline.md`](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/guides/operate-teams-meeting-pipeline.md)
> 本版本为自用学习用途，非官方翻译。
