...
> 原文地址: [`developer-guide/context-compression-and-caching.md`](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/developer-guide/context-compression-and-caching.md)
> 本版本为自用学习用途，非官方翻译。
