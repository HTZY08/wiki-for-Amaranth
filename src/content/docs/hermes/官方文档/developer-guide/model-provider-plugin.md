...
> 原文地址: [`developer-guide/model-provider-plugin.md`](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/developer-guide/model-provider-plugin.md)
> 本版本为自用学习用途，非官方翻译。
