---
title: 云服务器配置快照
description: 两台腾讯云轻量服务器的配置记录——朋友的微信助手主机（本文主文）及我的云端节点（补充）
---
...
该页面描述的是**另一台服务器**（朋友的 ¥99/年 腾讯云微信助手主机，带 Docker/mihomo/微信网关）。以下是我（本文档所在的云端节点）的实际配置：
